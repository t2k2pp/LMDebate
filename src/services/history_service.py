...
class HistoryService:
    ...
    def list_debates(self) -> list[Debate]:
        ...
        return [self._row_to_debate(row) for row in cur.fetchall()]
    ...
    def get_participants(self, debate_id: str) -> list[Participant]:
        ...
        return [self._row_to_participant(row) for row in cur.fetchall()]
    ...
    def get_attachments(
        ...
        return [self._row_to_attachment(row) for row in cur.fetchall()]
